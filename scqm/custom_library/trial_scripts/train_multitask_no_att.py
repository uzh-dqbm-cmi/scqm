...
if __name__ == "__main__":
    ...
    if reload:
        with open(
            "/cluster/work/medinfmk/scqm/tmp/final_model/saved_cv.pickle", "rb"
        ) as f:
            cv = pickle.load(f)
    else:
        # TODO adapt (obsolete)
    ...
    size_out_dict["patients"] = model_specifics["size_history"]
    ...
    with open("/cluster/work/medinfmk/scqm/tmp/trainer_no_att.pickle", "wb") as handle:
