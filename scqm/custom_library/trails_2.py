from models import Othernet
from modules import *
from training import AdaptivenetTrainer
from partition import DataPartition
from preprocessing import load_dfs_all_data, preprocessing, extract_other_features
...
if __name__ == '__main__':
    ...
    model_specifics = {'size_embedding': 5,
                       'num_layers_enc': 2,
                       'hidden_enc': 100,
                       'size_history': 10,
                       'num_layers': 1,
    ...
    trainer = AdaptivenetTrainer(model, dataset, n_epochs=40, batch_size=batch_size,
