...
class CVAdaptivenet(CVWrapper):
    def perform_cv(self, fold, n_epochs = 400, file='/cluster/home/ctrottet/code/scqm_cv_results/', search='random', num_combi=1):
        ...
        with open(filename, 'w') as f:
            ...
            for ind, (size_embedding, num_layers_enc, hidden_enc, size_history, num_layers, num_layers_pred, hidden_pred, p, lr, bal) in enumerate(combinations):
                ...
                accuracy, accuracy_valid = trainer.train_model(model, self.dataset, self.partition, debug_patient=False)
...
if __name__ == '__main__':
    ...
    cv.perform_cv(fold=0, n_epochs=2)
